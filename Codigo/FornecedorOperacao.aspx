<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FornecedorOperacao.aspx.cs" Inherits="Estudo.Web.GestaoConhecimento.FornecedorOperacao" %>
                ...
                <div class="col-sm-12">
                    <div class="col-sm-12 form-group">
                        <div class="text-uppercase">
                            ...
                            <span>AQUI VOCÊ INCLUI/ALTERA O FORNECEDOR DO CERTIFICADO.</span>
                            <hr>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4 form-group">
                                <label class="control-label" for="txtNome">Fornecedor</label>
                        ...
                        <div role="button" onclick="javascript:ForceToggle('<%=collapseOne.ClientID%>','iconeaprovador')">
                            <h3><span class="text-bold"><i class="icon-minus" id="iconeaprovador"></i>GRUPOS</h3>
                        </div>
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <asp:DropDownList ID="ddlgrupo" CssClass="combobox form-control" runat="server" DataValueField="idgrupo" DataTextField="nome" Width="100%"></asp:DropDownList>
                                                </div>--%>
                                                    <div class="col-sm-10 form-group">
                                                        <label for="type-db">Grupo</label>
                                                        <telerik:RadComboBox RenderMode="Classic" CssClass="dsp-block combobox form-control" Skin="Metro" ID="ddlgrupo" AutoPostBack="false" runat="server" Width="100%" Font-Names="Estudotxtregular" Font-Size="14px" ForeColor="#6d6e71">
                                                        </telerik:RadComboBox>
                                                    </div>
                                            ...
                                            <div class="row" runat="server" id="dvgrupos" visible="false">
                                                <div class="col-sm-12">
                                                    <div class="panel panel-default">
                                                        <div class="panel-body">
                                                            <asp:GridView ID="grdgrupo" CssClass="table table-striped table-responsive" runat="server" AutoGenerateColumns="false"
                                                                OnRowCommand="grdfornecedor_RowCommand"
                                                                DataKeyNames="idgrupo, nomegrupo, status" GridLines="Horizontal" BorderStyle="none" CellSpacing="-1">
                                                                <Columns>
                                                                    <asp:BoundField Visible="True" DataField="nomegrupo" HeaderText="Nome"></asp:BoundField>
