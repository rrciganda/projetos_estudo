<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="GrupoPesquisar.aspx.cs" Inherits="Estudo.Web.GestaoConhecimento.GrupoPesquisar" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <asp:UpdatePanel ID="ajaxtela" runat="server">
        <ContentTemplate>
            <%--Aqui começa sua view--%>
            <div class="row content">
                <div class="col-sm-12">
                    <div class="col-sm-12 form-group">
                        <div class="text-uppercase">
                            <h1 class="text-bold">GRUPO</h1>
                            <span>AQUI VOCÊ PESQUISA OS GRUPOS DE CERTIFICAÇÃO</span>
                            <hr>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <asp:GridView ID="grdpesquisa" CssClass="table table-striped table-responsive" runat="server" AutoGenerateColumns="false"
                                    ...
                                    OnPageIndexChanging="grdpesquisa_PageIndexChanging" DataKeyNames="idgrupo, nome, observacao, status" GridLines="Horizontal" BorderStyle="none" CellSpacing="-1">
                                    <Columns>
