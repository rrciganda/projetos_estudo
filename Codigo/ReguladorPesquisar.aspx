<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReguladorPesquisar.aspx.cs" Inherits="Estudo.Web.GestaoConhecimento.ReguladorPesquisar" %>
                ...
                <div class="col-sm-12">
                    <div class="col-sm-12 form-group">
                        <div class="text-uppercase">
                            ...
                            <span>AQUI VOCÊ PESQUISA OS REGULADORES DE CERTIFICADOS</span>
                            <hr>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4 form-group">
                                <label for="txtRegulador">Regulador</label>
                            ...
                            <div class="col-sm-12">
                                <asp:GridView ID="grdpesquisa" CssClass="table table-striped table-responsive" runat="server" AutoGenerateColumns="false"
                                    ...
                                    OnPageIndexChanging="grdpesquisa_PageIndexChanging" DataKeyNames="idregulador, nome, status" GridLines="None" BorderStyle="none" CellSpacing="-1" >
                                    <Columns>
